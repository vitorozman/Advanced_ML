...
class eqAlgo():
    ...
    def model(self, iter, happy, rate):
        """ Sprejme 
                iter ... stevilo iteracij
                happy ... zaljena napaka pri kateri ustavimo zanko
                rate ... vrednost s katero posodobimo verjetnosti
            Vrne: najbojso napako in najboljo enacbo
        """
        
        for i in range(iter+1):
            # robni primer ce ima gramatika cudne verjetnosti
            try:
                self.generat_eq()
            except:
                self.sample_size += 10
            ...
            # zacetna nastavitev parametrov
                ...
                # nastavimo zgodovino in posodobimo verjetnosti
    ...
    def update_prob(self, method="", rate=0.1):
        ...
        # izbira posodobitve verjetnosti
        if method == 'soft':
